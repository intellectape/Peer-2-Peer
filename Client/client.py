...
def main():
    ...
    try:
        ...
        # Starting the main thread for the Client to communicate with Centralized Server
        ...
        while True:
            ...
            if option == "ADD":
                ...
                rfcCount = int(input("Enter RFC's Available: ")) # Taking input of the number of RFC to input from the client side
            ...
            # This option will call download RFC 
                ...
                client.sock.send(pickle.dumps(["LOOKUP", "RFC", rfc_var, "P2P-CI/1.0"]))
                server_data = pickle.loads(client.sock.recv(1024))
                if type(server_data.message) == str:
                    print('Unable to find the given RFC on the Server.')
                else:
